...
def get_args():
    ...
    parser.add_argument('--sd', type=int, default=200, help='Simulation duration.')
    ...
    # -------- test parameters
    parser.add_argument('--tmod', type=str, default='epsilon_greedy', choices=['random', 'random_with_memory',\
                                    'degree_with_memory', 'epsilon_greedy', 'epsilon_memory', 'epsilon_degree'], 
    ...
    parser.add_argument('--mmod', type=str, default='commit', 
                            choices=['commit', 'comiso', 'degiso', '1hopiso', 'random'],
                            help='Mitigation strategy to be used with testing startegy. \
                                  ...
                                  random: commit but with no scoring and choosing candiates at random.')
    ...
    parser.add_argument('--mnbud', type=int, default=[2], nargs='+',
                            help='Mitigation neighbor selection budget: how many neighbors \
                                  the candidate will be restricted with.')
    parser.add_argument('--mrd', type=int, default=[3], nargs='+',
                            help='Mitigation restriction duration.')
    # mitigation specific parameters
    parser.add_argument('--cthr', type=float, default=[0.1], nargs='+',
                            help='The list of thresholds for comiso method in terms of the proportion of \
